        ...
        {props.route.params ? (
          <View style={{ borderWidth: 1, borderColor: "orange" }}>
            ...
            <View style={{ padding: 8 }}>
              <Text>Mode of Payment: {finalOrder.order.selectedPayment}</Text>
              <Text>
                Branch No: {finalOrder.order.storeContent.selectedStore}
              </Text>
              <Text>
                UserId: {finalOrder.order.storeContent.checkoutContent.user}
              </Text>
              <Text>
                Address: {finalOrder.order.storeContent.checkoutContent.houseNo},{" "}
